...
#include "HaloUIRichTextBlock.generated.h"

UCLASS(Blueprintable)
class HALOUI_API UHaloUIRichTextBlock : public UCommonRichTextBlock, public IHaloUITextStyleController, public IHaloUINarratableNodeInterface, public IHaloUINarratableNodeBlueprintableInterface {
    GENERATED_BODY()
public:
protected:
