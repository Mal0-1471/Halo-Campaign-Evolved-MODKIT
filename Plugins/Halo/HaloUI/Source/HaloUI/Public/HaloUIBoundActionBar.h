...
#include "HaloUIBoundActionBar.generated.h"

UCLASS(Blueprintable)
class HALOUI_API UHaloUIBoundActionBar : public UCommonBoundActionBar, public IHaloUINarratableNodeInterface, public IHaloUINarratableNodeBlueprintableInterface {
    GENERATED_BODY()
public:
protected:
