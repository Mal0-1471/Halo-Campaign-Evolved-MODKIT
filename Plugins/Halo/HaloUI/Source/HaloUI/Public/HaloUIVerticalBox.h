...
#include "HaloUIVerticalBox.generated.h"

UCLASS(Blueprintable)
class HALOUI_API UHaloUIVerticalBox : public UVerticalBox, public IHaloUINarratableNodeInterface, public IHaloUINarratableNodeBlueprintableInterface {
    GENERATED_BODY()
public:
protected:
