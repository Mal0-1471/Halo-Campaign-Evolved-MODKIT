...
#include "HaloUIHorizontalBox.generated.h"

UCLASS(Blueprintable)
class UHaloUIHorizontalBox : public UHorizontalBox, public IHaloUINarratableNodeInterface, public IHaloUINarratableNodeBlueprintableInterface {
    GENERATED_BODY()
public:
protected:
