...
#include "HaloUIScaleBox.generated.h"

UCLASS(Blueprintable)
class UHaloUIScaleBox : public UScaleBox, public IHaloUINarratableNodeInterface, public IHaloUINarratableNodeBlueprintableInterface {
    GENERATED_BODY()
public:
protected:
