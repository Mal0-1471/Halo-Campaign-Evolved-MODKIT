...
#include "HaloUICanvasPanel.generated.h"

UCLASS(Blueprintable)
class UHaloUICanvasPanel : public UCanvasPanel, public IHaloUINarratableNodeInterface, public IHaloUINarratableNodeBlueprintableInterface {
    GENERATED_BODY()
public:
protected:
