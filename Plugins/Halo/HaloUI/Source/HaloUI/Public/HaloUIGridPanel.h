...
#include "HaloUIGridPanel.generated.h"

UCLASS(Blueprintable)
class UHaloUIGridPanel : public UGridPanel, public IHaloUINarratableNodeInterface, public IHaloUINarratableNodeBlueprintableInterface {
    GENERATED_BODY()
public:
protected:
