...
#include "HaloUITileView.generated.h"
...
class HALOUI_API UHaloUITileView : public UCommonTileView, public IHaloUIViewItemListener, public IHaloUINarratableNodeInterface, public IHaloUINarratableNodeBlueprintableInterface {
    GENERATED_BODY()
public:
