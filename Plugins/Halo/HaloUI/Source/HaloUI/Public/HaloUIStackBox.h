...
#include "HaloUIStackBox.generated.h"

UCLASS(Blueprintable)
class UHaloUIStackBox : public UPanelWidget, public IHaloUINarratableNodeInterface, public IHaloUINarratableNodeBlueprintableInterface {
    GENERATED_BODY()
public:
