...
#include "HaloUISizeBox.generated.h"

UCLASS(Blueprintable)
class HALOUI_API UHaloUISizeBox : public USizeBox, public IHaloUINarratableNodeInterface, public IHaloUINarratableNodeBlueprintableInterface {
    GENERATED_BODY()
public:
protected:
