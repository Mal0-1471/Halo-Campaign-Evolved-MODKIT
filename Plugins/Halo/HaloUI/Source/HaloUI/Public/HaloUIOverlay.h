...
#include "HaloUIOverlay.generated.h"

UCLASS(Blueprintable)
class UHaloUIOverlay : public UOverlay, public IHaloUINarratableNodeInterface, public IHaloUINarratableNodeBlueprintableInterface {
    GENERATED_BODY()
public:
protected:
